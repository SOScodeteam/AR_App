...
using UnityEngine;
using Vuforia;
using UnityEngine.Video; // added 31 May 19 -- Capt Kyle Seifert
...
public class TrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        // added 31 May 19 -- Capt Kyle Seifert
        // Enable video play when target is found
    ...
    protected virtual void OnTrackingLost()
    {
        ...
        // added 31 May 19 -- Capt Kyle Seifert
        // Pause video play when target is lost.
        if (mTrackableBehaviour.gameObject.GetComponentInChildren<VideoPlayer>() != null)
        {
